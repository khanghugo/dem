...
impl EngineMessage {
    ...
    fn id(&self) -> u8 {
        match self {
            ...
            EngineMessage::SvcDisconnect(what) => 2,
            EngineMessage::SvcEvent(what) => 3,
            EngineMessage::SvcVersion(what) => 4,
            EngineMessage::SvcSetView(what) => 5,
            EngineMessage::SvcSound(what) => 6,
            EngineMessage::SvcTime(what) => 7,
            EngineMessage::SvcPrint(what) => 8,
            EngineMessage::SvcStuffText(what) => 9,
            EngineMessage::SvcSetAngle(what) => 10,
            EngineMessage::SvcServerInfo(what) => 11,
            EngineMessage::SvcLightStyle(what) => 12,
            EngineMessage::SvcUpdateUserInfo(what) => 13,
            EngineMessage::SvcDeltaDescription(what) => 14,
            EngineMessage::SvcClientData(what) => 15,
            EngineMessage::SvcStopSound(what) => 16,
            EngineMessage::SvcPings(what) => 17,
            EngineMessage::SvcParticle(what) => 18,
            EngineMessage::SvcDamage => 19,
            EngineMessage::SvcSpawnStatic(what) => 20,
            EngineMessage::SvcEventReliable(what) => 21,
            EngineMessage::SvcSpawnBaseline(what) => 22,
            EngineMessage::SvcTempEntity(what) => 23,
            EngineMessage::SvcSetPause(what) => 24,
            EngineMessage::SvcSignOnNum(what) => 25,
            EngineMessage::SvcCenterPrint(what) => 26,
            EngineMessage::SvcKilledMonster => 27,
            EngineMessage::SvcFoundSecret => 28,
            EngineMessage::SvcSpawnStaticSound(what) => 29,
            EngineMessage::SvcIntermission => 30,
            EngineMessage::SvcFinale(what) => 31,
            EngineMessage::SvcCdTrack(what) => 32,
            EngineMessage::SvcRestore(what) => 33,
            EngineMessage::SvcCutscene(what) => 34,
            EngineMessage::SvcWeaponAnim(what) => 35,
            EngineMessage::SvcDecalName(what) => 36,
            EngineMessage::SvcRoomType(what) => 37,
            EngineMessage::SvcAddAngle(what) => 38,
            EngineMessage::SvcNewUserMsg(what) => 39,
            EngineMessage::SvcPacketEntities(what) => 40,
            EngineMessage::SvcDeltaPacketEntities(what) => 41,
            EngineMessage::SvcChoke => 42,
            EngineMessage::SvcResourceList(what) => 43,
            EngineMessage::SvcNewMovevars(what) => 44,
            EngineMessage::SvcResourceRequest(what) => 45,
            EngineMessage::SvcCustomization(what) => 46,
            EngineMessage::SvcCrosshairAngle(what) => 47,
            EngineMessage::SvcSoundFade(what) => 48,
            EngineMessage::SvcFileTxferFailed(what) => 49,
            EngineMessage::SvcHltv(what) => 50,
            EngineMessage::SvcDirector(what) => 51,
            EngineMessage::SvcVoiceInit(what) => 52,
            EngineMessage::SvcVoiceData(what) => 53,
            EngineMessage::SvcSendExtraInfo(what) => 54,
            EngineMessage::SvcTimeScale(what) => 55,
            EngineMessage::SvcResourceLocation(what) => 56,
            EngineMessage::SvcSendCvarValue(what) => 57,
            EngineMessage::SvcSendCvarValue2(what) => 58,
        }
    }
}
